        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <a href="<?php echo base_url("Dashboard/export_rekap/").$k->tahun ?>"><button class="btn" id="exportrekap"><i class="fa fa-file-pdf-o"></i> Export to PDF</button></a>
                    <?php }?>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
